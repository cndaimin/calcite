...
public class SqlVolcanoTest {
    ...
    public static void main(String[] args) throws SqlParseException {
        ...
        RelNode relNode0 = planner.changeTraits(relNode, desiredTraits);

        planner.setRoot(relNode0);
        RelNode resultRelNode = planner.findBestExp();
        System.out.println("-----------------------------------------------------------");
        System.out.println("The Best relational expression string:");
        System.out.println(RelOptUtil.toString(resultRelNode));
        System.out.println("-----------------------------------------------------------");
    }
}